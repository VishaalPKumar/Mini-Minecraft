...
struct InputBundle {
    bool wPressed, aPressed, sPressed, dPressed,
        qPressed, ePressed, fPressed, spacePressed;
    float mouseX, mouseY;
...
constexpr float ACC_AMT = 100.0f;
constexpr float GRAVITY = 80.0f;
constexpr float JUMP_FORCE = 45.0f;
constexpr float MOUSE_SENSITIVITY = 0.01f;
constexpr float COLLISION_OFFSET = 0.001f;
constexpr float BLOCK_ACTION_RANGE = 3.f;
constexpr float FLOATING_SPEED = 10.f;
